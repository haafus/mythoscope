...
try:
    ...
    EmbeddingAnalyzer = _imp("03_project.analyzer").EmbeddingAnalyzer
except ImportError:
    logger.error("Error: 03_project was not found. Make sure it is installed or available in the project.")
    sys.exit(1)
...
if __package__:
    ...
    _cluster_metrics = _imp("04_cluster.metrics")
    _cluster_models = _imp("04_cluster.models")
    _cluster_viz = _imp("04_cluster.visualization")
    calculate_clustering_metrics = _cluster_metrics.calculate_clustering_metrics
    get_clustering_model = _cluster_models.get_clustering_model
    list_available_models = _cluster_models.list_available_models
    plot_clustering_results_2d = _cluster_viz.plot_clustering_results_2d
    plot_confusion_matrix_heatmap = _cluster_viz.plot_confusion_matrix_heatmap
    plot_metrics_dashboard = _cluster_viz.plot_metrics_dashboard
    reduce_dimensions = _cluster_viz.reduce_dimensions
...
def build_clusters():
    ...
    _analyzer_mod = _imp("03_project.analyzer")
    analyzer = _analyzer_mod.EmbeddingAnalyzer()
