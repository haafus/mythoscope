...
import { renderCorpus } from "./page-corpus.js?v=5";
import { renderEmbeddings } from "./page-embeddings.js?v=3";
import { renderGraphPage } from "./page-graphs.js?v=13";
import { renderGeography } from "./page-geography.js?v=64";
