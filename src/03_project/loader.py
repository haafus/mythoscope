...
_chroma = _imp("02_embed.chroma_manager")
collection_name_for_model = _chroma.collection_name_for_model
is_model_collection_name = _chroma.is_model_collection_name
