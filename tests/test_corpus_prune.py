...
build_embeddings prunes orphan chunks. Config-authoritative; the raw archive is untouched."""

import settings as settings_mod
from corpus.builder import _prune_orphan_texts


def test_prunes_txt_not_in_keep_set_and_leaves_raw(tmp_path, monkeypatch):
    ...
    _prune_orphan_texts([kept])                    # keep set = configured documents' text paths
