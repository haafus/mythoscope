...
- [`color-system-review.md`](archive/color-system-review.md) — deep dive on the category-colour system: where colours are generated, stored, passed and used across back end and front end, with every duplicate and inconsistency. *Folded into `../proposals/archive/tradition-architecture-unified.md` → `region-implementation.md`.*
