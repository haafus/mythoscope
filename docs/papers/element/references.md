...
*Computational Comparative Mythology: A Natural History of the Motif — unified bibliography. Draft.*

The single deduplicated works-cited list for the Element, merged from the source drafts and the
annotated canon. Alphabetical by first author. Original authors of all source datasets are cited here
and in the data-availability note (Appendix D).

- Abello, J., Broadwell, P., & Tangherlini, T. R. (2012). Computational folkloristics. *Communications
  of the ACM* 55(7), 60–70.
...
- Alyami, S., & Finlayson, M. A. (2026). Fine-tuned large-language-model narrative-motif detection on
  the *Arabian Nights* (preprint, per review).
...
- d'Huy, J. (2013). A phylogenetic approach to mythology and its archaeological consequences. *Rock Art
...
- Lin, J., Keogh, E., Lonardi, S., & Chiu, B. (2003). A symbolic representation of time series, with
  implications for streaming algorithms (SAX). *DMKD workshop*.
...
- Pastor-Sánchez, J.-A., Kontopoulos, E., Saorín, T., Bebis, H., & Darányi, S. (2021). Ontology of Greek
  mythology. *Semantic Web*.
...
- Yarlott, W. V. H., Acharya, A., Castro Estrada, D., Gomez, D., & Finlayson, M. A. (2024). GOLEM: a
  corpus of motif use in narrative. *LREC-COLING*.
