...
Part V  — Open Problems & Outlook   (NEW — see below)
Back matter
...
### Part V · Open Problems & Outlook (new, ~one chapter)

Assembled from material already written but scattered, so the book ends on the frontier rather than a
restated conclusion:
