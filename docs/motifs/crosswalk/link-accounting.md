...
| 4 | распарсили из summary ATU (inline-коды) | 4342 | +46 | 6388 |
| 5 | замыкание троек (inferred) | 12 | +12 | 6400 |
...
| лексические, tier A (near-identical + possible) | 1849 пар |
| лексические, tier B (weaker) | 1653 пар |
| из tier A — трёхсторонние (triangles) | 22 |
...
|---|---|---|---|
| ATU ↔ TMI | 4573 | **6400** | +1827 |
| Berezkin ↔ ATU | 584 | **626** | +42 |
| Berezkin ↔ TMI | 230 | **248** | +18 |
| **Всего подтверждённых** | 5387 | **7274** | +1887 |

Плюс **3624** подсказок сверху (отдельными слоями).
